...
def setup_room_1():
    ...
    for i in range(0, 20):
        ...
        if l != 0 and l != SPRITE_SIZE or b != SCREEN_HEIGHT * 4 and b != SCREEN_HEIGHT * 5:
            wall.left = l * SPRITE_SIZE
            wall.bottom = b * SPRITE_SIZE
            room.wall_list.append(wall)
...
def setup_room_2():
    ...
    for y in (0, SCREEN_HEIGHT - SPRITE_SIZE):
        # Loop for each box going across
        for x in range(0, SCREEN_WIDTH, SPRITE_SIZE):
            if (x != SPRITE_SIZE * 9 and x != SPRITE_SIZE * 10) or y != 0:
                wall = arcade.Sprite(":resources:images/tiles/boxCrate_double.png", SPRITE_SCALING)
                wall.left = x
                wall.bottom = y
                room.wall_list.append(wall)
    ...
    for i in range(0, 20):
        ...
        l = random.randint(1, 11)
        b = random.randint(1, 11)
        if (l != SCREEN_WIDTH - SPRITE_SIZE and l != SCREEN_WIDTH - SPRITE_SIZE * 2 or b != SCREEN_HEIGHT * 4 and b != SCREEN_HEIGHT * 5) and (
                b != 0 and b != SPRITE_SIZE or l != SCREEN_WIDTH * 9 and l != SCREEN_WIDTH * 10):
            wall.left = l * SPRITE_SIZE
            wall.bottom = b * SPRITE_SIZE
            room.wall_list.append(wall)
...
def setup_room_3():
    ...
    for i in range (0,20):
        ...
        l = random.randint(1, 11)
        b = random.randint(1, 11)
        if b != SCREEN_HEIGHT-SPRITE_SIZE and b != SCREEN_HEIGHT-SPRITE_SIZE*2 or l != SCREEN_WIDTH*9 and l != SCREEN_WIDTH*10:
            wall.left = l * SPRITE_SIZE
            wall.bottom = b * SPRITE_SIZE
            room.wall_list.append(wall)
